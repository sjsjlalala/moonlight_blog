package com.example.blog_auth.util;
...
public class MailUtils {
    ...
    // 发件人邮箱地址
    private static final String emailAccount = "1136232183@qq.com"; // 这个是普通QQ邮箱
    // 发件人邮箱授权码
    private static final String emailPassword = "vbcbkebhubhubaca";
    ...
    public static boolean sendEmail(Set<String> emails, String title, String content) {
        ...
        try {
            ...
            message.setFrom(new InternetAddress(emailAccount, "MoonLight博客", "UTF-8"));
