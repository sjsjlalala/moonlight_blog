...
public class BlogController {
    ...
    @PostMapping("/blogDetailByUid")
    public CommonResponse<BlogDetailVO> blogDetailByUid(@RequestBody BlogVO blogVO) {
        return blogService.blogDetail(blogVO);
    }
    ...
    public CommonResponse fetchBlogListByTag(@NotNull @PathVariable String tagUid) {
        return blogService.fetchBlogListByTag(tagUid);
    }

    @ApiOperation(value = "根据uid删除博客", notes = "根据uid删除博客")
    @PostMapping("/deleteBlogByUid")
    public CommonResponse deleteBlogByUid(@NotNull @Param(value = "uid") String uid) {
        return blogService.deleteBlogById(uid);
    }

    @ApiOperation(value = "登录后，获取博客完整信息", notes = "登录后，获取博客完整信息")
    @PostMapping("/getBlogLikeAndCollection")
    public CommonResponse getBlogLikeAndCollection(@RequestBody BlogVO blogVO) {
        return blogService.getBlogLikeAndCollection(blogVO);
    }
    @ApiOperation(value = "根据uid更新博客", notes = "根据uid更新博客")
    @PostMapping("/updateBlogByUid")
    public CommonResponse updateBlogById(@RequestBody BlogVO blog) {
    ...
    public CommonResponse getUserHomePage(@PathVariable String uid){
        return blogService.getUserHomePage(uid);
    }
